...
| BM-B01 | Formato del número de radicado (AAAAMM vs año) | Corrección | Alta | Alto | M | **Implementado** (ADR-0024: AAAAMM en entrada y salida, consecutivo anual intacto) | Ejecutado | por definir |
...
| BM-B33 | Subsanación Ley 1755 Art. 17: requerimiento al ciudadano + **suspensión del término** + desistimiento tácito (1 mes) | Nueva func. | Media-Alta | Alto | M-L | **✅ IMPLEMENTADO Y VERIFICADO** (piezas 1–5; suite 993/993; revisión cruzada gobierno-digital/seguridad/qa/ia-simi integrada) — [BM-B33](blueprints/BM-B33-subsanacion-suspension-terminos.md) | Ejecutado | C3 |
| BM-B34 | Borrador asistido por SIMI del "motivo" del requerimiento (solo qué falta; IA sugiere, funcionario decide) | Mejora (IA) | Baja-Media | Medio | S | Identificado (evaluado por ia-simi: reutiliza `solicitud_aclaracion` + prompt acotado, sin módulo nuevo) | En evaluación — opcional | C3/C8 |
...
| BM-B05 | Regla de 24 h para reasignación por no competencia | Nueva func. | Media-Alta | Alto | M | **Gap confirmado (barrido P-001, Act.3/Obs.2)**: existe traslado/devolver pero NO se controla el plazo de 24h (grep SLA=0). Ortogonal a H3 | Requiere validación normativa/funcionaria | C3 |
