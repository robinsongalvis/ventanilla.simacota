...
| BM-B33 | Subsanación Ley 1755 Art. 17: requerimiento al ciudadano + **suspensión del término** + desistimiento tácito (1 mes) | Nueva func. | Media-Alta | Alto | M-L | Identificado (gap real del núcleo; hoy `devolver` es interno y NO suspende el término) | En evaluación — requiere Blueprint + validación normativa | C3 |
